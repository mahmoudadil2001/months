...
def main():
    ...
    # أسماء الأيام بالعربي (بدءًا من الاثنين)
    days_ar = ["الاثنين", "الثلاثاء", "الأربعاء", "الخميس", "الجمعة", "السبت", "الأحد"]
    today_name = days_ar[now.weekday()]

    # شريط جانبي لاختيار عدد الأيام للنقل
    ...
    # عرض التاريخ المنقول في الشريط الجانبي من اليسار إلى اليمين
    ...
    # حساب التاريخ الهجري للتاريخ المنقول مع معالجة الخطأ إذا كان التاريخ بعيد جدًا
    try:
    ...
    # جلب التواريخ الحالية للواجهة الرئيسية
    dates = get_dates()
